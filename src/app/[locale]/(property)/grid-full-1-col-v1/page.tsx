...
export default function GridFull1ColV1Page() {
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="bg-homez-dark py-12">
        <div className="container-homez text-center">
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Properties - Single Column V1
          </h1>
          <p className="text-white/70 max-w-2xl mx-auto">
            Horizontal card layout for detailed property browsing
          </p>
        </div>
      </div>
      ...
      <div className="container-narrow py-8">
        ...
        {/* Properties List - Single Column with Horizontal Cards */}
