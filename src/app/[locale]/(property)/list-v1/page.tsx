...
import { LayoutGrid, LayoutList, Map, Home } from 'lucide-react';

const ITEMS_PER_PAGE = 8;

export default function ListV1Page() {
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="bg-homez-dark py-12">
        <div className="container-homez text-center">
          ...
          <p className="text-white/70 max-w-2xl mx-auto">
            Horizontal layout for detailed property browsing
          </p>
        </div>
      </div>
      ...
      <div className="container-homez py-8">
        ...
        {/* Toolbar */}
        <div className="flex flex-wrap items-center justify-between gap-4 my-6 bg-white rounded-xl border shadow-sm p-4">
