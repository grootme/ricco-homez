# Dashboard Add Property - Publicar Propiedad

## Información General

| Campo | Valor |
|-------|-------|
| **Página** | dashboard-add-property |
| **Categoría** | dashboard |
| **URL** | /(dashboard)/dashboard-add-property |

## Descripción

Formulario para publicar una nueva propiedad con pasos: información básica, ubicación, detalles, imágenes y publicación.
...
`src/app/[locale]//(dashboard)/dashboard-add-property/page.tsx`
