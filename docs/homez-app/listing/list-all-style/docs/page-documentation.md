# List All Style - Listado Completo

## Información General

| Campo | Valor |
|-------|-------|
| **Página** | list-all-style |
| **Categoría** | listing |
| **URL** | /(property)/list-all-style |
| **Tipo** | Server-rendered (Dynamic) |

## Descripción

Listado completo de propiedades en formato de lista con todas las opciones de filtrado.
...
`src/app/[locale]//(property)/list-all-style/page.tsx`
