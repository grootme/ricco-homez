# Home V10 - Variante de Página Principal #10
...
Décima variante con layout full-width, mapa interactivo y propiedades en formato cards con filtros.
...
`src/app/[locale]//(home)/home-v10/page.tsx`
