# Home V5 - Variante de Página Principal #5
...
Quinta variante con slider de hero, buscador con filtros rápidos y propiedades recientes.
...
`src/app/[locale]//(home)/home-v5/page.tsx`
