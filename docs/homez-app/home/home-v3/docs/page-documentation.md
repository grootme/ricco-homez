# Home V3 - Variante de Página Principal #3
...
Tercera variante con mapa interactivo en la sección principal, buscador avanzado y propiedades en la cercanía.
...
`src/app/[locale]//(home)/home-v3/page.tsx`
