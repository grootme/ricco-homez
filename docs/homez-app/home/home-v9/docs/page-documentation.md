# Home V9 - Variante de Página Principal #9
...
Novena variante con diseño split-screen, buscador lateral y galería de propiedades.
...
`src/app/[locale]//(home)/home-v9/page.tsx`
