# Home V8 - Variante de Página Principal #8
...
Octava variante con animaciones de scroll, propiedades premium y sección de agentes destacados.
...
`src/app/[locale]//(home)/home-v8/page.tsx`
