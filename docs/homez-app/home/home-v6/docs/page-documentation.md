# Home V6 - Variante de Página Principal #6
...
Sexta variante con diseño minimalista, buscador prominente y lista de propiedades destacadas.
...
`src/app/[locale]//(home)/home-v6/page.tsx`
